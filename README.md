...
</style><title>最终实验记录</title>
</head>
<body class='typora-export os-windows'><div class='typora-export-content'>
<div id='write'  class=''><h1 id='目前分类准确率'><span>目前分类准确率</span></h1><blockquote><p><span>LHNet Laplacian Convolutional Block for Remote Sensing Image Scene Classification</span></p><p><span>别人的网络在两个数据上的结果（最后4列）</span></p></blockquote><p><img src="https://gitee.com/meiruni/image/raw/master/img/image-20221119232401716.png" referrerpolicy="no-referrer" alt="image-20221119232401716"></p><h1 id='nwpu-resisc45数据集'><span>NWPU-RESISC45数据集</span></h1><p><strong><span>参数设置如下</span></strong></p><figure><table><thead><tr><th><span>epoch</span></th><th><span>batchsize</span></th><th><span>lr</span></th><th><span>lr(last layer)</span></th><th><span>Weight decay</span></th><th><span>Momentum</span></th></tr></thead><tbody><tr><td><span>100</span></td><td><span>64/50</span></td><td><span>0.001</span></td><td><span>0.1</span></td><td><span>0.0005</span></td><td><span>0.9</span></td></tr></tbody></table></figure><p><strong><span>训练结果</span></strong></p><figure><table><thead><tr><th><span>model_name</span></th><th><span>10%训练集acc</span></th><th><span>20%训练集acc</span></th></tr></thead><tbody><tr><td><span>Fine-tuned VGGNet16</span></td><td><span>87.33%</span></td><td><span>90.33%</span></td></tr><tr><td><span>Fine-tuned ResNet50</span></td><td><span>89.85%</span></td><td><span>92.58%</span></td></tr><tr><td><span>Fine-tuned DenseNet121</span></td><td><span>89.62%</span></td><td><span>92.12%</span></td></tr></tbody></table></figure><h1 id='可视化结果-1'><span>可视化结果</span></h1><h3 id='1nwpu-resisc45-ftvgg16-test-and-loss'><span>1.NWPU-RESISC45 FT_VGG16 TEST and LOSS</span></h3><!--注：为什么训练集10%或者20%？因为提出这个数据集的团队，最初做实验是这样设置数据集比例的--><blockquote><p><span>训练集10%，测试集90% </span>
<span>微调的VGG16网络在NWPU-RESISC45数据集训练集和测试集的准确率上升，损失下降情况</span></p></blockquote><center style="display:flex ">
    <img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120153038652.png" alt="image-20221120153038652" style="zoom:67%;">
    <img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120153252734.png" alt="image-20221120153252734" style="zoom:67%;">
</center><blockquote><p><span>训练集20%，测试集80%</span></p><p><span>微调的VGG16网络在NWPU-RESISC45数据集训练集和测试集的准确率上升，损失下降情况</span></p></blockquote><center style="display:flex;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120152319162.png" alt="image-20221120152319162" style="zoom: 67%;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120152408051.png" alt="image-20221120152408051" style="zoom:67%;">
</center><p>&nbsp;</p><h3 id='2nwpu-resisc45-ftresnet50test-and-loss'><span>2.NWPU-RESISC45 FT_ResNet50TEST and LOSS</span></h3><blockquote><p><span>训练集10%，测试集90%</span></p><p><span>微调的ResNet50网络在NWPU-RESISC45数据集训练集和测试集的准确率上升，损失下降情况</span></p></blockquote><center style="display:flex;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120153646334.png" alt="image-20221120153646334" style="zoom:67%;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120153720201.png" alt="image-20221120153720201" style="zoom:67%;">
</center><p>&nbsp;</p><blockquote><p><span>训练集20%，测试集80%</span></p><p><span>微调的ResNet50网络在NWPU-RESISC45数据集训练集和测试集的准确率上升，损失下降情况</span></p></blockquote><center style="display:flex;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120154209041.png" alt="image-20221120154209041" style="zoom:67%;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120154238226.png" alt="image-20221120154238226" style="zoom:67%;">
</center><p>&nbsp;</p><p>&nbsp;</p><h3 id='3nwpu-resisc45-ftdensenet121-test-and-loss'><span>3.NWPU-RESISC45 FT_DenseNet121 TEST and LOSS</span></h3><blockquote><p><span>训练集10%，测试集90%</span></p><p><span>微调的DenseNet121网络在NWPU-RESISC45数据集训练集和测试集的准确率上升，损失下降情况</span></p></blockquote><center style="display:flex;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120154615506.png" alt="image-20221120154615506" style="zoom:67%;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120154631066.png" alt="image-20221120154631066" style="zoom:67%;">
</center><p>&nbsp;</p><blockquote><p><span>训练集20%，测试集80%</span></p><p><span>微调的DenseNet121网络在NWPU-RESISC45数据集训练集和测试集的准确率上升，损失下降情况</span></p></blockquote><center style="display:flex;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120154452596.png" alt="image-20221120154452596" style="zoom:67%;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221120154509200.png" alt="image-20221120154509200" style="zoom:67%;">
<center></center></center><p>&nbsp;</p><h3 id='4loss-contrast-1'><span>4.Loss Contrast</span></h3><blockquote><p><span>三个模型在NMPU-RESISC45数据集上测试集的</span><strong><span>损失函数下降</span></strong><span>情况；</span></p><p><span>V代表NGG16，R代表ResNet50,D代表DenseNet121,NW45表示NWPU-RESISC45遥感场景分类数据集</span></p><p><span>可以看到不论是10%还是20%的训练集比例，</span><strong><span>蓝色</span></strong><span>那条线（</span><strong><span>ResNet50</span></strong><span>）最优。</span></p></blockquote><center style="display:flex;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221121103840114.png" alt="image-20221120154933577" style="margin-left: 0px; zoom: 67%;">
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221121103949642.png" alt="image-20221120155125478" style="margin-right: 0px; zoom: 67%;">
...
<img src="https://gitee.com/meiruni/image/raw/master/img/image-20221121103551580.png" alt="image-20221120161330461" style="zoom:67%;">
